...
const NO_MODELS_TIP = "Run {highlight}ruying-code login{/highlight} to sign in with GWM SSO"
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}ruying-code login{/highlight} to refresh your GWM SSO login",
  ...
  "Create {highlight}ruying-code.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  "Place TUI settings in {highlight}~/.config/ruying-code/tui.json{/highlight} for global config",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Add {highlight}.md{/highlight} files to {highlight}.ruying-code/commands/{/highlight} for reusable prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.ruying-code/agents/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.ruying-code/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.ruying-code/plugins/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent 如影 Code from reading sensitive files",
  "Use {highlight}ruying-code run{/highlight} for non-interactive scripting",
  "Use {highlight}ruying-code --continue{/highlight} to resume the last session",
  "Use {highlight}ruying-code run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}ruying-code serve{/highlight} for headless API access to 如影 Code",
  "Use {highlight}ruying-code run --attach{/highlight} to connect to a running server",
  "Run {highlight}ruying-code upgrade{/highlight} to update to the latest version",
  "Run {highlight}ruying-code login{/highlight} to refresh your GWM SSO session",
  "Run {highlight}ruying-code agent create{/highlight} for guided agent creation",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.ruying-code/themes/{/highlight} directory",
  ...
  "Run {highlight}ruying-code debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}ruying-code login{/highlight} to authenticate with the 如影 coding gateway",
