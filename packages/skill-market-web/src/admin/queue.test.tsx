...
describe("moderation queue", () => {
  test("shows stable risk/status labels and oldest-first wait information", async () => {
    ...
    expect([...view.container.querySelectorAll(".moderation-table tbody td:first-child strong")].every((item) => item.classList.contains("type-card-title"))).toBe(true)
    expect([...view.container.querySelectorAll(".moderation-table tbody td:nth-child(2) strong")].every((item) => item.classList.contains("type-card-title"))).toBe(true)
    expect([...view.container.querySelectorAll(".moderation-table tbody td small")].every((item) => item.classList.contains("type-secondary"))).toBe(true)
