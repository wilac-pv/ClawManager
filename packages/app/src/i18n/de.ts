...
export const dict = {
  ...
  "skillMarket.search": "Search Skills",
  "skillMarket.scope.all": "All",
  "skillMarket.scope.featured": "Featured",
  "skillMarket.scope.enterprise": "Enterprise",
  "skillMarket.scope.installed": "Installed",
  "skillMarket.scope.updates": "Updates",
  "skillMarket.sort.trending": "Trending",
  "skillMarket.sort.downloads": "Downloads",
  "skillMarket.sort.recent": "Recently added",
  "skillMarket.filter.source": "Source",
  "skillMarket.filter.category": "Category",
  "skillMarket.filter.apiKey": "API Key",
  "skillMarket.filter.all": "All",
  "skillMarket.view.list": "List view",
  "skillMarket.view.cards": "Card view",
  "skillMarket.tab.overview": "Overview",
  "skillMarket.tab.versions": "Version history",
  "skillMarket.tab.security": "Security reports",
  "skillMarket.action.install": "Install",
  "skillMarket.action.update": "Update",
  "skillMarket.action.uninstall": "Uninstall",
  "skillMarket.action.refresh": "Retry loading",
  "skillMarket.action.back": "Back to Skills",
  "skillMarket.action.copyPrompt": "Copy install prompt",
  "skillMarket.action.download": "Download ZIP",
  "skillMarket.action.confirmRisk": "Accept risk and install",
  "skillMarket.action.confirmUninstall": "Confirm uninstall",
  "skillMarket.risk.accept": "I have read and accept the risks of this Skill",
  "skillMarket.state.installing": "Installing",
  "skillMarket.state.installed": "Installed",
  "skillMarket.state.updateAvailable": "Update available",
  "skillMarket.state.refreshFailed": "Installed, but failed to load",
  "skillMarket.empty": "No matching Skills found",
  "skillMarket.offline": "The network is unavailable. Installed Skills can still be managed.",
  "skillMarket.source.stale": "Some sources are unavailable. Showing the latest successful data.",
  "skillMarket.risk.unknown": "Unknown risk",
  "skillMarket.risk.safe": "Safe",
  "skillMarket.risk.warning": "Risk detected",
  "skillMarket.risk.danger": "High risk",
  "skillMarket.error.network-unavailable": "The network is unavailable. Check your connection and try again.",
  "skillMarket.error.market-unavailable": "The Skill market is temporarily unavailable. Try again later.",
  "skillMarket.error.skill-delisted": "This Skill has been removed and cannot be installed or updated.",
  "skillMarket.error.risk-confirmation-required": "Review and accept the security risks before continuing.",
  "skillMarket.error.hash-mismatch": "Package verification failed. The Skill was not installed.",
  "skillMarket.error.unsafe-archive": "The Skill package contains unsafe files and was rejected.",
  "skillMarket.error.archive-limit": "The Skill package exceeds the safe extraction limit.",
  "skillMarket.error.invalid-skill": "The package is not a valid Skill.",
  "skillMarket.error.disk-unavailable":
    "The Skill could not be written to disk. Check available space and permissions.",
  "skillMarket.error.version-conflict": "A newer Skill version is available. Refresh and try again.",
  "skillMarket.error.not-market-owned": "This Skill was not installed by the market and cannot be managed here.",
  "skillMarket.error.refresh-failed": "The Skill was installed, but could not be loaded. Retry loading.",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Ruying Code",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Ruying Code zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Ruying Code Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Ruying Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Ruying Code zu nutzen.",
  ...
  "dialog.plugins.empty": "In ruying-code.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Ruying Code-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Ruying Code",
  ...
  "wsl.onboarding.checkingOpencode": "Ruying Code wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Ruying Code in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Ruying Code wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Ruying Code in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Ruying Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ruying Code aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Ruying Code ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Ruying Code ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Ruying Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Ruying Code installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Ruying Code nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Ruying Code einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Ruying Code konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Ruying Code erneut.",
  ...
  "toast.update.description": "Eine neue Version von Ruying Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Ruying Code-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (ruying-code.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Ruying Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Ruying Code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Ruying Code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Ruying Code ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Ruying Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Ruying Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Ruying Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Ruying Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Ruying Code.",
