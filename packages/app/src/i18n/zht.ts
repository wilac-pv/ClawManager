...
export const dict = {
  ...
  "skillMarket.title": "Skill 市場",
  "skillMarket.search": "搜尋 Skills",
  "skillMarket.scope.all": "全部",
  "skillMarket.scope.featured": "推薦精選",
  "skillMarket.scope.enterprise": "企業精選",
  "skillMarket.scope.installed": "已安裝",
  "skillMarket.scope.updates": "可更新",
  "skillMarket.sort.trending": "近期熱門",
  "skillMarket.sort.downloads": "下載量",
  "skillMarket.sort.recent": "最近上架",
  "skillMarket.filter.source": "來源",
  "skillMarket.filter.category": "場景分類",
  "skillMarket.filter.apiKey": "API Key",
  "skillMarket.filter.all": "全部",
  "skillMarket.view.list": "列表檢視",
  "skillMarket.view.cards": "卡片檢視",
  "skillMarket.tab.overview": "概述",
  "skillMarket.tab.versions": "版本歷史",
  "skillMarket.tab.security": "安全報告",
  "skillMarket.action.install": "安裝",
  "skillMarket.action.update": "升級",
  "skillMarket.action.uninstall": "解除安裝",
  "skillMarket.action.refresh": "重試載入",
  "skillMarket.action.back": "返回 Skills",
  "skillMarket.action.copyPrompt": "複製安裝 Prompt",
  "skillMarket.action.download": "下載 ZIP",
  "skillMarket.action.confirmRisk": "確認風險並安裝",
  "skillMarket.action.confirmUninstall": "確認解除安裝",
  "skillMarket.risk.accept": "我已閱讀並接受此 Skill 的風險",
  "skillMarket.state.installing": "安裝中",
  "skillMarket.state.installed": "已安裝",
  "skillMarket.state.updateAvailable": "可更新",
  "skillMarket.state.refreshFailed": "已安裝，載入失敗",
  "skillMarket.empty": "找不到符合條件的 Skill",
  "skillMarket.offline": "網路不可用，仍可管理已安裝的 Skill",
  "skillMarket.source.stale": "部分來源暫時不可用，目前顯示最近一次成功資料",
  "skillMarket.risk.unknown": "風險未知",
  "skillMarket.risk.safe": "安全",
  "skillMarket.risk.warning": "存在風險",
  "skillMarket.risk.danger": "高風險",
  "skillMarket.error.network-unavailable": "網路不可用，請檢查連線後重試。",
  "skillMarket.error.market-unavailable": "Skill 市場暫時不可用，請稍後重試。",
  "skillMarket.error.skill-delisted": "此 Skill 已下架，無法安裝或升級。",
  "skillMarket.error.risk-confirmation-required": "請先閱讀並接受安全風險，再繼續操作。",
  "skillMarket.error.hash-mismatch": "安裝包驗證失敗，未安裝此 Skill。",
  "skillMarket.error.unsafe-archive": "安裝包包含不安全檔案，已拒絕安裝。",
  "skillMarket.error.archive-limit": "安裝包超過安全解壓縮限制。",
  "skillMarket.error.invalid-skill": "安裝包不是有效的 Skill。",
  "skillMarket.error.disk-unavailable": "無法寫入 Skill，請檢查磁碟空間和目錄權限。",
  "skillMarket.error.version-conflict": "已有更新版本，請重新整理市場後重試。",
  "skillMarket.error.not-market-owned": "此 Skill 不是透過市場安裝，無法在這裡管理。",
  "skillMarket.error.refresh-failed": "Skill 已安裝但載入失敗，請重試載入。",
  ...
  "dialog.model.unpaid.freeModels.title": "Ruying Code 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Ruying Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Ruying Code Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Ruying Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Ruying Code 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 ruying-code.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Ruying Code 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Ruying Code...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Ruying Code...",
  "wsl.onboarding.updatingOpencode": "正在更新 Ruying Code...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Ruying Code...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Ruying Code。",
  "wsl.onboarding.updateOpencode": "更新 Ruying Code",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Ruying Code 已就緒。",
  "wsl.onboarding.opencodeReady": "Ruying Code 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Ruying Code。",
  "wsl.onboarding.installOpencode": "安裝 Ruying Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Ruying Code",
  ...
  "wsl.onboarding.wslUnavailable.description": "Ruying Code 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Ruying Code。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Ruying Code 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (ruying-code.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Ruying Code 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Ruying Code 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Ruying Code 伺服器。",
