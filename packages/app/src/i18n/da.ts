export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Ruying Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Ruying Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Ruying Code...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Ruying Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Ruying Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Ruying Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Ruying Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Ruying Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Ruying Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Ruying Code igen.",
  ...
  "toast.update.description": "En ny version af Ruying Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, Ruying Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.desktop.wsl.description": "Kør Ruying Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Ruying Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Ruying Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Ruying Code følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Ruying Code er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Ruying Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Ruying Code.",
