...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Ruying Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Ruying Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Ruying Code Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Ruying Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Ruying Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i ruying-code.json",
  ...
  "dialog.server.description": "Bytt hvilken Ruying Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Ruying Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Ruying Code-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (ruying-code.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Ruying Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Ruying Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Ruying Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Ruying Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Ruying Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Ruying Code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Ruying Code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Ruying Code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Ruying Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Ruying Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Ruying Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Ruying Code...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Ruying Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Ruying Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Ruying Code",
  "wsl.onboarding.opencodeReadyIn": "Ruying Code er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Ruying Code er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Ruying Code i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Ruying Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Ruying Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Ruying Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Ruying Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Ruying Code på nytt.",
