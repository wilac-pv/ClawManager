export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ Ruying Code...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ Ruying Code ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต Ruying Code...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต Ruying Code ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต Ruying Code ใน {{distro}}.",
  "wsl.onboarding.updateOpencode": "อัปเดต Ruying Code",
  "wsl.onboarding.opencodeReadyIn": "Ruying Code พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.opencodeReady": "Ruying Code พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง Ruying Code ใน {{distro}}.",
  "wsl.onboarding.installOpencode": "ติดตั้ง Ruying Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง Ruying Code",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Ruying Code ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.chain.mcpFailed":
    'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Ruying Code ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Ruying Code ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Ruying Code",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Ruying Code มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Ruying Code ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Ruying Code มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Ruying Code เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Ruying Code เวอร์ชันล่าสุด",
