export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ruying Codeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Ruying Codeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Ruying Code Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してRuying Codeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Ruying Codeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "ruying-code.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するRuying Codeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Ruying Codeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のRuying Codeを確認中...",
  "wsl.onboarding.updatingOpencode": "Ruying Codeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のRuying Codeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のRuying Codeを更新してください。",
  "wsl.onboarding.updateOpencode": "Ruying Codeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のRuying Codeの準備ができました。",
  "wsl.onboarding.opencodeReady": "Ruying Codeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にRuying Codeをインストールしてください。",
  "wsl.onboarding.installOpencode": "Ruying Codeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Ruying Codeがインストールされていません",
  ...
  "toast.update.description": "Ruying Codeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをRuying Codeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (ruying-code.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: Ruying CodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Ruying Codeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でRuying Codeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Ruying Codeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのRuying Codeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description":
    "Ruying Codeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Ruying Codeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Ruying Code の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Ruying Code は最新バージョンです。",
