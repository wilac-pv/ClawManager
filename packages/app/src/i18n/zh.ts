...
export const dict = {
  ...
  "skillMarket.error.network-unavailable": "网络不可用，请检查连接后重试。",
  "skillMarket.error.market-unavailable": "Skill 市场暂时不可用，请稍后重试。",
  "skillMarket.error.skill-delisted": "此 Skill 已下架，无法安装或升级。",
  "skillMarket.error.risk-confirmation-required": "请先阅读并接受安全风险，再继续操作。",
  "skillMarket.error.hash-mismatch": "安装包校验失败，未安装此 Skill。",
  "skillMarket.error.unsafe-archive": "安装包包含不安全文件，已拒绝安装。",
  "skillMarket.error.archive-limit": "安装包超过安全解压限制。",
  "skillMarket.error.invalid-skill": "安装包不是有效的 Skill。",
  "skillMarket.error.disk-unavailable": "无法写入 Skill，请检查磁盘空间和目录权限。",
  "skillMarket.error.version-conflict": "已有更新版本，请刷新市场后重试。",
  "skillMarket.error.not-market-owned": "此 Skill 不是通过市场安装，无法在这里管理。",
  "skillMarket.error.refresh-failed": "Skill 已安装但加载失败，请重试加载。",
  ...
  "dialog.provider.opencode.note": "使用 Ruying Code Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "Ruying Code 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Ruying Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Ruying Code Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Ruying Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的帐户并在 Ruying Code 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 ruying-code.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Ruying Code 服务器。",
  ...
  "wsl.onboarding.step.opencode": "如影 Code",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查如影 Code...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的如影 Code...",
  "wsl.onboarding.updatingOpencode": "正在更新如影 Code...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的如影 Code...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的如影 Code。",
  "wsl.onboarding.updateOpencode": "更新如影 Code",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的如影 Code 已就绪。",
  "wsl.onboarding.opencodeReady": "如影 Code 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装如影 Code。",
  "wsl.onboarding.installOpencode": "安装如影 Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装如影 Code",
  ...
  "wsl.onboarding.wslNotInstalled.description": "如影 Code 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "如影 Code 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开如影 Code。",
  ...
  "toast.update.description": "Ruying Code 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Ruying Code 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (ruying-code.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Ruying Code 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Ruying Code 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行如影 Code 服务器。",
  ...
  "settings.general.row.language.description": "更改 Ruying Code 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Ruying Code 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Ruying Code 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Ruying Code 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Ruying Code 启动时自动检查更新",
