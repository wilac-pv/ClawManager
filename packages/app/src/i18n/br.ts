export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Ruying Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Ruying Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Ruying Code Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Ruying Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Ruying Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados em ruying-code.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Ruying Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Ruying Code...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Ruying Code em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Ruying Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Ruying Code em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Ruying Code em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Ruying Code",
  "wsl.onboarding.opencodeReadyIn": "O Ruying Code está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Ruying Code está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Ruying Code em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Ruying Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Ruying Code não instalado",
  ...
  "toast.update.description": "Uma nova versão do Ruying Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Ruying Code",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (ruying-code.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Ruying Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Ruying Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Ruying Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Ruying Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o Ruying Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Ruying Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Ruying Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Ruying Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Ruying Code.",
