export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Ruying Code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Ruying Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Ruying Code Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Ruying Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Ruying Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados en ruying-code.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Ruying Code se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Ruying Code...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Ruying Code en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Ruying Code...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Ruying Code en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Ruying Code en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Ruying Code",
  "wsl.onboarding.opencodeReadyIn": "Ruying Code está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Ruying Code está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Ruying Code en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Ruying Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Ruying Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Ruying Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Ruying Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Ruying Code.",
  ...
  "toast.update.description": "Una nueva versión de Ruying Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Ruying Code",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (ruying-code.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Ruying Code no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Ruying Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Ruying Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Ruying Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Ruying Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Ruying Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Ruying Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Ruying Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Ruying Code.",
