...
describe("layout deep links", () => {
  test("parses open-project deep links", () => {
    expect(parseDeepLink("ruying-code://open-project?directory=/tmp/demo")).toBe("/tmp/demo")
  ...
  test("parses new-session deep links with optional prompt", () => {
    expect(parseNewSessionDeepLink("ruying-code://new-session?directory=/tmp/demo")).toEqual({
      directory: "/tmp/demo",
    })
    expect(parseNewSessionDeepLink("ruying-code://new-session?directory=/tmp/demo&prompt=hello%20world")).toEqual({
      directory: "/tmp/demo",
      prompt: "hello world",
    })
