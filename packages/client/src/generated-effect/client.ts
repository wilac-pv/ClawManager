...
type Endpoint13_0Request = Parameters<RawClient["server.skillMarket"]["skillMarket.list"]>[0]
type Endpoint13_0Input = {
  readonly query?: Endpoint13_0Request["query"]["query"]
  readonly source?: Endpoint13_0Request["query"]["source"]
  readonly category?: Endpoint13_0Request["query"]["category"]
  readonly requiresApiKey?: Endpoint13_0Request["query"]["requiresApiKey"]
  readonly featured?: Endpoint13_0Request["query"]["featured"]
  readonly enterprise?: Endpoint13_0Request["query"]["enterprise"]
  readonly sort?: Endpoint13_0Request["query"]["sort"]
  readonly page?: Endpoint13_0Request["query"]["page"]
  readonly limit?: Endpoint13_0Request["query"]["limit"]
}
const Endpoint13_0 = (raw: RawClient["server.skillMarket"]) => (input?: Endpoint13_0Input) =>
  raw["skillMarket.list"]({
    query: {
      query: input?.["query"],
      source: input?.["source"],
...
const Endpoint13_1 = (raw: RawClient["server.skillMarket"]) => () =>
  raw["skillMarket.facets"]({}).pipe(Effect.mapError(mapClientError))

type Endpoint13_2Request = Parameters<RawClient["server.skillMarket"]["skillMarket.detail"]>[0]
type Endpoint13_2Input = {
  readonly source: Endpoint13_2Request["params"]["source"]
  readonly id: Endpoint13_2Request["params"]["id"]
}
const Endpoint13_2 = (raw: RawClient["server.skillMarket"]) => (input: Endpoint13_2Input) =>
  raw["skillMarket.detail"]({ params: { source: input["source"], id: input["id"] } }).pipe(
    Effect.mapError(mapClientError),
  )

const Endpoint13_3 = (raw: RawClient["server.skillMarket"]) => () =>
  raw["skillMarket.installed"]({}).pipe(Effect.mapError(mapClientError))

const Endpoint13_4 = (raw: RawClient["server.skillMarket"]) => () =>
  raw["skillMarket.updates"]({}).pipe(Effect.mapError(mapClientError))

type Endpoint13_5Request = Parameters<RawClient["server.skillMarket"]["skillMarket.install"]>[0]
type Endpoint13_5Input = {
  readonly source: Endpoint13_5Request["payload"]["source"]
  readonly id: Endpoint13_5Request["payload"]["id"]
  readonly version: Endpoint13_5Request["payload"]["version"]
  readonly sha256: Endpoint13_5Request["payload"]["sha256"]
  readonly riskConfirmed?: Endpoint13_5Request["payload"]["riskConfirmed"]
}
const Endpoint13_5 = (raw: RawClient["server.skillMarket"]) => (input: Endpoint13_5Input) =>
  raw["skillMarket.install"]({
    payload: {
      source: input["source"],
      id: input["id"],
...
type Endpoint13_6Request = Parameters<RawClient["server.skillMarket"]["skillMarket.update"]>[0]
type Endpoint13_6Input = {
  readonly source: Endpoint13_6Request["payload"]["source"]
  readonly id: Endpoint13_6Request["payload"]["id"]
  readonly version: Endpoint13_6Request["payload"]["version"]
  readonly sha256: Endpoint13_6Request["payload"]["sha256"]
  readonly riskConfirmed?: Endpoint13_6Request["payload"]["riskConfirmed"]
}
const Endpoint13_6 = (raw: RawClient["server.skillMarket"]) => (input: Endpoint13_6Input) =>
  raw["skillMarket.update"]({
    payload: {
      source: input["source"],
      id: input["id"],
      version: input["version"],
...
type Endpoint13_7Request = Parameters<RawClient["server.skillMarket"]["skillMarket.uninstall"]>[0]
type Endpoint13_7Input = {
  readonly source: Endpoint13_7Request["params"]["source"]
  readonly id: Endpoint13_7Request["params"]["id"]
}
const Endpoint13_7 = (raw: RawClient["server.skillMarket"]) => (input: Endpoint13_7Input) =>
  raw["skillMarket.uninstall"]({ params: { source: input["source"], id: input["id"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint13_8Request = Parameters<RawClient["server.skillMarket"]["skillMarket.refresh"]>[0]
type Endpoint13_8Input = {
  readonly source: Endpoint13_8Request["params"]["source"]
  readonly id: Endpoint13_8Request["params"]["id"]
}
const Endpoint13_8 = (raw: RawClient["server.skillMarket"]) => (input: Endpoint13_8Input) =>
  raw["skillMarket.refresh"]({ params: { source: input["source"], id: input["id"] } }).pipe(
    Effect.mapError(mapClientError),
  )

const adaptGroup13 = (raw: RawClient["server.skillMarket"]) => ({
  list: Endpoint13_0(raw),
  facets: Endpoint13_1(raw),
  detail: Endpoint13_2(raw),
  installed: Endpoint13_3(raw),
  updates: Endpoint13_4(raw),
  install: Endpoint13_5(raw),
  update: Endpoint13_6(raw),
  uninstall: Endpoint13_7(raw),
  refresh: Endpoint13_8(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  skillMarket: adaptGroup13(raw["server.skillMarket"]),
