...
const main = Effect.scoped(
  Effect.gen(function* () {
    ...
    const auth = createAuth({
      ...
      ssoCheckTokenUrl: config.ssoCheckTokenUrl,
      ssoPlatformCode: config.ssoPlatformCode,
      departmentLookupUrl: config.departmentLookupUrl,
      departmentLookupAppCode: config.departmentLookupAppCode,
