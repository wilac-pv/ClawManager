export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Ruying Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Ruying Code er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'ruying-code'-kommandoen.",
